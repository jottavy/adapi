...
-- RG1
CREATE TYPE etat_objet          AS ENUM ('bon_etat', 'a_reparer', 'hors_service');
-- RG5
CREATE TYPE statut_objet        AS ENUM ('arrive', 'en_reparation', 'en_rayon', 'vendu', 'recycle');
-- RG6
CREATE TYPE resultat_reparation AS ENUM ('reussie', 'echouee');
-- RG8
